    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(sortButton, &QPushButton::clicked, this, &MainWindow::sortBlogsByLikes);

    // 设置搜索按钮
    searchInput = new QLineEdit;
    searchInput->setPlaceholderText("输入景点名称搜索");
    searchButton = new QPushButton("搜索");
    connect(searchButton, &QPushButton::clicked, this, &MainWindow::searchBlogs);
...
void MainWindow::loadBlogs(bool sortByLikes, const QString& searchQuery )
{
    QSqlQuery query(db);
...
void MainWindow::likeBlog(int blogId)
{
    QSqlQuery query(db);
...
void MainWindow::addComment(int blogId, const QString& comment)
{
    QSqlQuery query(db);
...
void MainWindow::sortBlogsByLikes()
{
    QString str=this->searchInput->text();
    loadBlogs(true,str);
}

void MainWindow::viewComments(int blogId)
{
    QSqlQuery query(db);
